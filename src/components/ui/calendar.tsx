...
import { zhCN as zhCNBase } from 'date-fns/locale';
...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      components={{
        IconLeft: ({ ...props }) => <ChevronLeftIcon className="h-4 w-4" aria-label="上个月" />,
        IconRight: ({ ...props }) => <ChevronRightIcon className="h-4 w-4" aria-label="下个月" />,
      }}
      {...props}
    />
  );
